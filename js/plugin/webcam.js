...
window.webcam = {
	...
	get_html: function(width, height, server_width, server_height, wmode) {
		...
		if (this.ie) {
			html += '<object classid="clsid:d27cdb6e-ae6d-11cf-96b8-444553540000" ' +
                ...
                ' width="'+width+'" height="'+height+'" id="webcam_movie" align="middle">' +
			...
			html += '<embed id="webcam_movie" src="'+this.swf_url+'" loop="false" menu="false" ' +
                'quality="best" bgcolor="#ffffff" width="'+width+'" height="'+height+'" ' +
                'name="webcam_movie" align="middle" allowScriptAccess="always" ' +
                'allowFullScreen="false" type="application/x-shockwave-flash" wmode="'+wmode+'"' +
